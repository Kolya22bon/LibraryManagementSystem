...
namespace LibraryManagementSystem.Tests
{
    public class LibraryManagementTests
    {
        ...
        private void ResetLibraryInstance()
        {
            try
            {
                var instanceField = typeof(Library).GetField("instance", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static);
                ...
                {
                    throw new InvalidOperationException("Failed to find the 'instance' field in the Library class.");
                }
            }
            catch (Exception ex)
            {
                throw new InvalidOperationException("Failed to reset the Library singleton instance", ex);
            }
        }
